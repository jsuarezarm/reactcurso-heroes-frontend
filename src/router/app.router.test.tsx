...
vi.mock('@/heores/layouts/HeroesLayout', () => ({
  HeroesLayout: () =>
...
vi.mock('@/heores/pages/home/HomePage', () => ({
  HomePage: () => <div data-testid="home-page"></div>
}));

vi.mock('@/heores/pages/hero/HeroPage', () => ({
  HeroPage: () => {
...
vi.mock('@/heores/pages/search/SearchPage', () => ({
...
describe('app.router', () => {
  ...
  test('should render home page at toot path', () => {
  ...
  test('should redirect to home page for unknown routes', () => {
    const router = createMemoryRouter(appRouter.routes, {
      initialEntries: ['/other-not-defined-page']
    });
