...
describe('CustomPagination', () => {
  ...
  test('should disable next button 3 when we are in page 3', () => {
    ...
    // expect(button3.getAttributeNames()).toContain('disabled');
    expect(button2.getAttribute('variant')).toBe('outline');
    expect(button3.getAttribute('variant')).toBe('default');
  });

  test('should change page click on number button', () => {
